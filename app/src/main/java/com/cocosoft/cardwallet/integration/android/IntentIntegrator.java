...
package com.cocosoft.cardwallet.integration.android;
...
public class IntentIntegrator {
  ...
  private static final String BS_PACKAGE = "com.cocosoft.cardwallet.client.android";
   ...
   *
   * @param text the text string to encode as a barcode
   * @param type type of data to encode. See {@code com.cocosoft.cardwallet.client.android.Contents.Type} constants.
   * @return the {@link android.app.AlertDialog} that was shown to the user prompting them to download the app
   *   if a prompt was needed, or null otherwise
   */
